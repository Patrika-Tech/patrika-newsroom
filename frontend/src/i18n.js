...
export const dict = {
  en: {
    ...
    nav: {
      ...
      ai: 'AI Insights', alerts: 'Alerts Center', reports: 'Reports', feedback: 'Feedback', settings: 'Settings'
    },
    kpi: {
  ...
  hi: {
    ...
    nav: {
      ...
      ai: 'एआई इनसाइट्स', alerts: 'अलर्ट सेंटर', reports: 'रिपोर्ट्स', feedback: 'फीडबैक', settings: 'सेटिंग्स'
    },
    kpi: {
