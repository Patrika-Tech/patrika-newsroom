...
export const dict = {
  en: {
    ...
    nav: {
      ...
      ai: 'AI Insights', alerts: 'Alerts Center', reports: 'Reports', tasks: 'Task Management', correspondent: 'Correspondent', 'news-generator': 'News Generator', feedback: 'Feedback', digital_tracker: 'Digital Tracker', settings: 'Settings'
    },
    kpi: {
  ...
  hi: {
    ...
    nav: {
      ...
      ai: 'एआई इनसाइट्स', alerts: 'अलर्ट सेंटर', reports: 'रिपोर्ट्स', tasks: 'टास्क मैनेजमेंट', correspondent: 'संवाददाता', 'news-generator': 'न्यूज़ जनरेटर', feedback: 'फीडबैक', digital_tracker: 'डिजिटल ट्रैकर', settings: 'सेटिंग्स'
    },
    kpi: {
