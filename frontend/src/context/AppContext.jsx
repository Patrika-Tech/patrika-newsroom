...
const ACCESS = {
  'Admin':           'all',
  'State Head':      ['home', 'editorial', 'production', 'pages', 'field', 'hr', 'alerts', 'reports', 'tasks', 'settings', 'feedback'],
  'Regional Editor': ['home', 'editorial', 'production', 'pages', 'field', 'hr', 'alerts', 'reports', 'tasks', 'settings', 'feedback'],
